...
public abstract class AbstractPersistentLogHandler {
    public static AmislcOperateLog buildPersistentLog(LogEnvTypeEnum envType,
                                                      LogRegister logRegister, LogPersistent logPersistent,
                                                      Map<String, Object> inputParamMap, Object outputParam) {
        final LogObjTypeEnum matchHandler = Objects.isNull(logRegister) ? null : logRegister.value();
